...
const Footer = () => {
  return (
    <footer className="w-full mt-16 relative bg-[url('src/assets/images/bg-pattern/footer-pattern.webp')] bg-cover bg-center bg-no-repeat">
      <div class="bg-[#bc8600f5] absolute inset-0 z-10"></div>
        ...
        <div className="py-2 border-t border-gray-200">
          <div className="flex content-font items-center justify-center flex-col sm:justify-between sm:flex-row">
            ...
            <div className="flex mt-6 space-x-4 sm:justify-center sm:mt-0 ">
              <a className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                <svg
                  className="transition-all duration-500 text-white group-hover:text-indigo-600"
                  width="21"
                  height="21"
                  viewBox="0 0 21 21"
                  fill="none"
              ...
              <a className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                <svg
                  className="w-[1.25rem] h-[1.125rem] transition-all duration-500 text-white group-hover:text-indigo-600"
                  viewBox="0 0 15 15"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <a className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                <svg
                  className="w-[1rem] h-[1rem] transition-all duration-500 text-white group-hover:text-indigo-600"
                  viewBox="0 0 13 12"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <a className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                <svg
                  className="w-[1.25rem] h-[0.875rem] transition-all duration-500 text-white group-hover:text-indigo-600"
                  viewBox="0 0 16 12"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
