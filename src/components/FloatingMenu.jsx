...
const FloatingMenu = () => {
  ...
  return (
    <div className="md:hidden block fixed bottom-2 left-1/2 -translate-x-1/2 w-[90%] max-w-md bg-[#11182575] text-white backdrop-blur border border-white/20 rounded-full flex justify-around py-3 px-2 z-40">
      {/* Menu */}
      <button
